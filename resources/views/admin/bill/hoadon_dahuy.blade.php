...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Bill Deleted
                    <small>List</small>
                </h1>
                @if(@session('thongbao'))
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX" align="center">
                        ...
                        <td><i class="fa fa-refresh fa-fw" aria-hidden="true"></i><a href="admin/bill/khoiphuc/{{$bill->id}}" onclick="return confirm('Bạn chắc chắn muốn khôi phục hóa đơn {{$bill->id}}')">Khôi phục</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
