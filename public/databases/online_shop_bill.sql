...
CREATE TABLE `bill` (
  ...
  CONSTRAINT `fk_order_shipper` FOREIGN KEY (`shipper_id`) REFERENCES `shipper` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `bill` VALUES (1,2,1,0,NULL),(2,2,2,2,NULL),(3,3,3,1,NULL),(4,4,4,0,NULL),(5,5,5,1,NULL);
